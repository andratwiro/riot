"""Build the opinion-map data for docs/prototypes/deliberate.html (the floor, demo page).
...
renders as precomputed JSON (docs/prototypes/deliberate-data.js):
...
Run:  python3 scripts/build_floor_map.py   (writes docs/prototypes/deliberate-data.js)
"""
...
with open("docs/prototypes/deliberate-data.js", "w") as f:
    f.write(js)
